            ...
            <main className='main'>
                ...
                <div className="cards-container">
                    <div className='card'>
                        ...
                        <p>To simplify a standard career path, break it into clear, relatable steps...</p>
                    ...
                    <div className='card'>
                        ...
                        <p>A custom career path enables individuals to design a flexible, personalized roadmap...</p>
                        <h6><Link to="/read">Read more</Link></h6>
                    </div>
                </div>
            </main>
